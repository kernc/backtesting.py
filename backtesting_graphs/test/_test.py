...
from backtesting_graphs import Backtest, Strategy
from backtesting_graphs._stats import compute_drawdown_duration_peaks
from backtesting_graphs.lib import (
    OHLCV_AGG,
    barssince,
    compute_stats,
    cross,
...
from backtesting_graphs.test import GOOG, EURUSD, SMA
from backtesting_graphs._util import _Indicator, _as_str, _Array, try_
...
class TestPlot(TestCase):
    ...
    def test_resample(self):
        bt = Backtest(GOOG, SmaCross)
        bt.run()
        import backtesting_graphs._plotting
        with _tempfile() as f,\
                patch.object(backtesting_graphs._plotting, '_MAX_CANDLES', 10),\
