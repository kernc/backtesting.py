""" File used to get the main dataframe to plot statistics. """
...
def compute_stats(
    ...
    if isinstance(trades, pd.DataFrame):
        ...
        trades_df = pd.DataFrame({
            ...
            'EntryTime': [t.entry_time.dt for t in trades],
            'ExitTime': [t.exit_time.dt for t in trades],
        })
    ...
    # _calc_df contains the calculations for plotting equity lines over time.
    #   Currently this includes a positions gross value in cash, net value in cash
    #   and net value in tokens.
    s.loc['_calc_df'] = calc_df
